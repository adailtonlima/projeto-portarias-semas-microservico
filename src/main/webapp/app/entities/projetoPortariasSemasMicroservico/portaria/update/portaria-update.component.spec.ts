...
import { SetorService } from 'app/entities/projetoPortariasSemasMicroservico/setor/service/setor.service';
import { IUsuario } from 'app/entities/projetoPortariasSemasMicroservico/usuario/usuario.model';
import { UsuarioService } from 'app/entities/projetoPortariasSemasMicroservico/usuario/service/usuario.service';
...
describe('Portaria Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Assunto query and add missing value', () => {
      ...
      const assunto: IAssunto = { id: 19126 };
      portaria.assunto = assunto;

      const assuntoCollection: IAssunto[] = [{ id: 14148 }];
    ...
    it('Should call Setor query and add missing value', () => {
      const portaria: IPortaria = { id: 456 };
      const setor: ISetor = { id: 16059 };
      portaria.setor = setor;

      const setorCollection: ISetor[] = [{ id: 10608 }];
    ...
    it('Should call Usuario query and add missing value', () => {
      const portaria: IPortaria = { id: 456 };
      const usuario: IUsuario = { id: 20726 };
      portaria.usuario = usuario;
      const updatedBy: IUsuario = { id: 8777 };
      portaria.updatedBy = updatedBy;
      const deletedBy: IUsuario = { id: 23245 };
      portaria.deletedBy = deletedBy;

      const usuarioCollection: IUsuario[] = [{ id: 7548 }];
    ...
    it('Should update editForm', () => {
      const portaria: IPortaria = { id: 456 };
      const assunto: IAssunto = { id: 31452 };
      portaria.assunto = assunto;
      const setor: ISetor = { id: 22576 };
      portaria.setor = setor;
      const usuario: IUsuario = { id: 11567 };
      portaria.usuario = usuario;
      const updatedBy: IUsuario = { id: 11973 };
      portaria.updatedBy = updatedBy;
      const deletedBy: IUsuario = { id: 10852 };
      portaria.deletedBy = deletedBy;
