...
import { PerfilService } from 'app/entities/projetoPortariasSemasMicroservico/perfil/service/perfil.service';
...
describe('Usuario Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Perfil query and add missing value', () => {
      ...
      const perfil: IPerfil = { id: 15546 };
      usuario.perfil = perfil;

      const perfilCollection: IPerfil[] = [{ id: 1298 }];
    ...
    it('Should call Setor query and add missing value', () => {
      const usuario: IUsuario = { id: 456 };
      const setor: ISetor = { id: 5827 };
      usuario.setor = setor;

      const setorCollection: ISetor[] = [{ id: 377 }];
    ...
    it('Should update editForm', () => {
      const usuario: IUsuario = { id: 456 };
      const perfil: IPerfil = { id: 17151 };
      usuario.perfil = perfil;
      const setor: ISetor = { id: 25751 };
      usuario.setor = setor;
