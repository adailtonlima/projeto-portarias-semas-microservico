...
describe('Ajuda Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Topico query and add missing value', () => {
      ...
      const topicos: ITopico[] = [{ id: 'b8ff3803-39b0-4ffc-8439-86e70b708609' }];
      ajuda.topicos = topicos;

      const topicoCollection: ITopico[] = [{ id: '3fcfc569-b2aa-41dc-a9b5-f6ccc420f5d2' }];
    ...
    it('Should update editForm', () => {
      const ajuda: IAjuda = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
      const topicos: ITopico = { id: '15b5037c-da11-49ba-baf1-2b3d611758e2' };
      ajuda.topicos = [topicos];
